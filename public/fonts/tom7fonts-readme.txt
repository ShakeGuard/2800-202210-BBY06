The file `levity.ttf` contains the font “Levity” by Tom Murphy VII.
The file `levity.woff2` was derived from the original TTF file, 
which is okay by the license.

License attached below:
